...
--
--   SELECT id, citation_path, body FROM corpus.provisions
...
--   LIMIT 500;
--
-- Before this index, the planner used provisions_citation_path_unique (plain
...
CREATE INDEX IF NOT EXISTS idx_provisions_doctype_citation_body
  ON corpus.provisions (doc_type, citation_path)
  WHERE body IS NOT NULL;
