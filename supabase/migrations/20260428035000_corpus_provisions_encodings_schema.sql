  ...
  LOOP
    ...
    LOOP
      IF EXISTS (
        ...
        EXECUTE format('ALTER TABLE %I.%I SET SCHEMA telemetry', source_schema_var, table_name_var);
      END IF;
    END LOOP;
  END LOOP;
END $$;
...
ALTER SEQUENCE IF EXISTS app.agent_transcripts_id_seq SET SCHEMA telemetry;
ALTER SEQUENCE IF EXISTS encodings.agent_transcripts_id_seq SET SCHEMA telemetry;
