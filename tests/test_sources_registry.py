...
from axiom_corpus.sources.registry import (
...
rate_limit: 1.5
max_retries: 5
custom_parser: axiom_corpus.parsers.us_ny
"""
        ...
        assert config.custom_parser == "axiom_corpus.parsers.us_ny"
...
class TestGetAllConfigs:
    def test_returns_configs(self):
        import axiom_corpus.sources.registry as registry_module
