...
from axiom_corpus.sources.base import SourceConfig, StatuteSource, load_source
...
class TestSourceConfig:
    ...
    def test_create_full(self):
        config = SourceConfig(
            ...
            rate_limit=1.0,
            max_retries=5,
            custom_parser="axiom_corpus.parsers.us_ny.statutes",
        )
...
class TestLoadSource:
    @patch("axiom_corpus.sources.registry.get_source_for_jurisdiction")
