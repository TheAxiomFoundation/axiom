...
def _get_builtin_configs() -> dict[str, SourceConfig]:
    ...
    return {
        ...
        "us-nj": SourceConfig(
            ...
            custom_parser="axiom.parsers.us_nj.statutes",  # Needs custom parser
        ),
        ...
        "us-co": SourceConfig(
            ...
            custom_parser="axiom.parsers.us_co.statutes",  # Needs PDF parser
        ),
        # Indiana
        "us-in": SourceConfig(
            jurisdiction="us-in",
        ...
        "us-tn": SourceConfig(
            ...
            custom_parser="axiom.parsers.us_tn.statutes",  # Needs custom for LexisNexis
        ),
        # Connecticut
        "us-ct": SourceConfig(
            jurisdiction="us-ct",
        ...
        "us-ar": SourceConfig(
            ...
            custom_parser="axiom.parsers.us_ar.statutes",
        ),
        # Kansas
        "us-ks": SourceConfig(
            jurisdiction="us-ks",
        ...
        "us-ms": SourceConfig(
            ...
            custom_parser="axiom.parsers.us_ms.statutes",
        ),
        # New Mexico
        "us-nm": SourceConfig(
            jurisdiction="us-nm",
...
def get_source_for_jurisdiction(jurisdiction: str) -> StatuteSource | None:
    ...
    if config.source_type == "uslm":
        ...
        if jurisdiction == "us-ny":
            from axiom.sources.api import NYLegislationSource
