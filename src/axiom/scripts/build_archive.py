...
Usage:
    python -m axiom.scripts.build_archive --all
    python -m axiom.scripts.build_archive --uscode 26 42
    python -m axiom.scripts.build_archive --guidance --years 2024
    python -m axiom.scripts.build_archive --state ny
"""
