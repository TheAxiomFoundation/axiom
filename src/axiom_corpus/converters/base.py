...
Usage:
    from axiom_corpus.converters.base import LegalDocConverter, register_converter, get_converter
...
# -----------------------------------------------------------------------------
# Akoma Ntoso Models (simplified for Axiom pipeline)
# -----------------------------------------------------------------------------
...
class AkomaNtoso(BaseModel):
    ...
    focused on the fields needed for the Axiom pipeline.
...
class LegalDocConverter(ABC):
    ...
    The to_rules() method converts AkomaNtoso to corpus.provisions dicts for DB insert.
    """
    ...
    def to_rules(self, akn: AkomaNtoso) -> Iterator[dict]:
        """Convert AkomaNtoso to corpus.provisions dictionaries for DB insert.

        Default implementation flattens sections and subsections into
        rule records matching the corpus.provisions schema.
        ...
        Yields:
            Dictionaries matching corpus.provisions table schema
        """
